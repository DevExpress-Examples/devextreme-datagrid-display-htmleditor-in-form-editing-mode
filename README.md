...
Note that you need to reference Quill on your page / in your project. It is necessary for HtmlEditor - see https://js.devexpress.com/Documentation/Guide/Widgets/HtmlEditor/Overview/
